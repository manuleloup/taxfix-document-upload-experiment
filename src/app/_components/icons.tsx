// Inline icon set ported 1:1 from taxfix-no-onboarding.html's SVG strings.
// Temporary — swap for @taxfix/ds-icons once that package is installable.
...
export function PendingIcon({ size = 13 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="12" cy="12" r="9" />
      <path d="M9.5 9a2.5 2.5 0 015 0c0 1.5-2 1.7-2 3.3" />
      <circle cx="12" cy="16.5" r="0.6" fill="currentColor" />
    </svg>
  );
}

export function DismissedIcon({ size = 13 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function LowConfidenceIcon({ size = 14 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 9v4" />
...
export function OverflowIcon({ size = 14 }: { size?: number }) {
  return (
...
export function statusIcon(status: "pending" | "confirmed" | "dismissed") {
  ...
  if (status === "dismissed") return <DismissedIcon />;
  return <PendingIcon />;
}
